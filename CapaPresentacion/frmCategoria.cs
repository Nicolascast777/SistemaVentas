    ...
    public partial class frmCategoria : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
            {
                ...
                {
                    // CORRECCIÓN: Usar CN_Categoria en lugar de CN_Usuario
                ...
                else
                {
                    ...
                    if (resultado)
                    {
                        ...
                        // CORRECCIÓN: Asegúrate que el nombre de la celda sea "Id" o "IdCategoria" según tu diseño
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            if (Convert.ToInt32(txtid.Text) != 0)
            {
                ...
                {
                    string mensaje = string.Empty;
                    Categoria objcategoria = new Categoria() // Cambié el nombre para que sea claro
                    {
                        IdCategoria = Convert.ToInt32(txtid.Text)
                    };

                    // CORRECCIÓN: Pasar el objeto correcto 'objcategoria'
                    bool respuesta = new CN_Categoria().Eliminar(objcategoria, out mensaje);

                    if (respuesta)
                    {
                        dgvdata.Rows.RemoveAt(Convert.ToInt32(txtindice.Text));
                        Limpiar(); // Añadido para limpiar los campos después de eliminar
                    }
                    else
                    {
