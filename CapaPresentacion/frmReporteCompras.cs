    ...
    public partial class frmReporteCompras : Form
    {
        ...
        private void btnexportar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                savefile.FileName = string.Format("ReporteCompras_{0}_.xlsx", DateTime.Now.ToString("ddMMyyyyHHmmss"));
                ...
                if (savefile.ShowDialog() == DialogResult.OK)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        MessageBox.Show(detalle, "Error Detallado", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
